...
export const projects: Project[] = [
  ...
  {
    slug: "agentic-for-good",
    title: "Agentic for Good",
    tagline:
      "NGO / research initiative: matching already-funded world problems to grant opportunities with agentic tooling.",
    category: "Initiative",
    status: "Active · grant research agent + partner site",
    problem:
      "Many globally important problems already have funding pathways, but founders and researchers struggle to find the right open calls, eligibility fit and evidence story — especially when prior technical work (like an education platform) needs to be framed for reviewers.",
    value:
      "Turns grant discovery from ad-hoc browsing into a structured match between problem themes and open/upcoming EU/US calls, with a partner briefing site to align co-founders — accelerating applications (e.g. EXIST, StIL Freiraum) without building vapourware demos.",
    solution:
      "Curated grants + problem datasets, a CLI matching/recommendation agent, an optional Agency Lens PoC (inspect / challenge / override loop), and a password-protected Next.js partner site. Funding asset cited: Daneshlab (source-grounded course platform).",
    deployment:
      "Local Node/TypeScript agent CLI; partner website designed for Vercel (env-gated password). PoC runnable via Vite. Public repo for collaboration.",
    metrics: [
      { label: "Focus", value: "Funded world problems" },
      { label: "Surface", value: "CLI + partner web" },
      { label: "Asset", value: "Daneshlab" },
      { label: "Hosts", value: "Local / Vercel" },
    ],
    stack: [
      "TypeScript",
      "Node CLI",
    ...
    links: [
      {
        label: "GitHub",
        href: "https://github.com/karansingh2427/agentic-for-good",
      },
      { label: "Daneshlab", href: "https://daneshlab.ai/" },
    ],
    featured: true,
    depth: [
      {
        question: "What it is",
        answer:
          "An initiative exploring how agentic AI can help solve already-funded world problems — starting with a grant-research agent that recommends problem focuses and matches them to open calls, plus a partner site for alignment.",
      },
      {
        question: "How it works",
        answer:
          "Seed JSON for grants and problem areas feeds matching/recommendation logic exposed via CLI (list, match, recommend). A thin Agency Lens PoC demonstrates inspect/challenge/override. The partner web app shares strategy behind a site password for co-founder review.",
      },
      {
        question: "Why it works",
        answer:
          "Grant success depends on eligibility, timing and credible prior art more than flashy demos. Structuring the search space and citing a real product (Daneshlab) keeps applications grounded in feasibility evidence reviewers can probe.",
      },
      {
        question: "Why I chose it",
        answer:
          "I wanted a personal, values-aligned AI project outside enterprise constraints — using the same product discipline (problem, evidence, MVP) while contributing to education and public-good funding pathways.",
      },
      {
        question: "What its limitations are",
        answer:
          "Grant data is curated, not a live scrape of every portal. Daneshlab still needs stronger impact evidence (reviewer access, multi-lesson courses, usage numbers) before heavy citation. The PoC is illustrative, not the headline artefact for every funder.",
      },
      {
        question: "What alternatives exist",
        answer:
          "Manual grant consultancy; generic LLM chat without structured match scores; building net-new products solely to satisfy call criteria. We deliberately lead with existing funded themes and prior technical assets.",
      },
      {
        question: "What happens when things don't work as expected",
        answer:
          "Match scores are advisory — humans still read eligibility. When a call's scope narrows (e.g. Prototype Fund), strategy pivots (EXIST, StIL) rather than forcing a misfit demo. Partner site access is password-gated so incomplete narratives are not public.",
      },
    ],
  },
  {
